...
battling system of Pokémon. Numerous other games have copied the Pokémon battling format, though none have been able to equal its widespread appeal and dedicated player base. With each successive iteration, new items, types, and of course Pokémon are added to the Pokémon lexicon. The world of Pokémon has continued to evolve and grow into one of the largest video games franchises. The most recent iterations of Pokémon games, Pokémon Omega Ruby and Alpha Sapphire, have continued the tradition of adding layers to an already complex system of battling. 
  ...
  However, becoming the best a difficult task. To aid in understanding and analyzing Pokémon battling a number of concepts from game theory and data analysis need to be considered.  
  ...
  On the theoretical side of analysis I determine how Pokémon battling fits into the schema of games. At its core Pokémon battling is a special case of a zero sum game played exclusively by two players. Additionally Pokémon battling lends itself to a discussion of imperfect and incomplete information, along with the role of signalling. A great portion of game theory literature has explored both topics. Specific to zero sum games, the pioneering literature of Von Neumann and Morgenstern laid the groundwork for game theory. Concerning the role of information, Zermelo in particular yields some important implications in analyzing Pokémon battling. Lastly the role of signalling as it relates to asymmetrical information is related to the work of Spence and Stiglitz. 
...
* Pokémon Showdown Github Master Repository (2016). Retrieved from: https://github.com/Zarel/Pokemon-Showdown/tree/master/data
* Schwalbe, Ulrich, and Paul Walker. "Zermelo and the Early History of Game Theory." Games and Economic Behavior 34.1 (2001): 123-37. Web. 
* Using Iterated Reasoning to Predict Opponent Strategies, Michael Wunder, Michael Kaisers, John Robert Yaros, Michael Littman, Proc. of 10th Int. Conf. on Autonomous Agents and Multiagent Systems (AAMAS 2011), Tumer, Yolum, Sonenberg and Stone (eds.), May, 2–6, 2011, Taipei, Taiwan, pp. 593-600. 
