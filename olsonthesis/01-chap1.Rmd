...
Scant rigorous or academic research has been conducted within the scope of Pokémon-related topics. Given the depth of the decision-making process involved in Pokémon battling, this fact is especially resonant. 

Typically papers have focused on the use of algorithms for the purpose of simulating player behavior and the analysis of battles in Pokémon Showdown. One paper focuses explicitly on 1v1 battles (*Gildardo 2013*). Similarly, even the more nuanced works have operated under gross simplifications. Nonetheless some have worked within the most current framework of Pokémon battling, specifically the currently used format in *Pokémon Showdown* (*Ho et al. 2016*). 
The host site of thus game is Smogon University, found at http://www.smogon.com/. This website offers a wide variety of resources, ranging from Pokémon usage statistics to open forums discussing team compositions. 
...
* Sanchez-Ante, Gildardo (2013, Dec) Sistemas Inteligentes: Reportes Finales Ago-Dic 2013. Retrieved from: https://www.researchgate.net/publication/259343975_Sistemas_Inteligentes_Reportes_Fi nales_Ago-Dic_2013* 
