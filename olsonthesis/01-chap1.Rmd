...
Scant rigorous or academic research has been conducted within the scope of Pokémon-related topics. The most frequent publications focusing on Pokémon have been strategies guides for each new Pokémon iteration. However these publications have focused more specifically on the games, not necessarily the mechanics of the battling in the games. Nonetheless recent publications have focused on both the game and the underlying system (*The Official Hoenn Region Strategy Guide*). Given the depth of the decision-making process involved in Pokémon battling, this fact is especially resonant. 

Typically academic papers have focused on the use of algorithms to simulate and play against human players in Pokémon Showdown. One paper gives a rudimentary background on Pokémon battling and focuses explicitly on 1v1 battles (*Gildardo 2013*). Recent literature following that followed included more nuance. The most relevant publication focuses on the most current framework of Pokémon battling (*Ho et al. 2016*). This publication used the latest iteration of Pokémon Showdown, available at http://pokemonshowdown.com/. 
The host site of this game is Smogon University, found at http://www.smogon.com/. This website offers a wide variety of resources, ranging from Pokémon usage statistics to open forums discussing team compositions. 

The two battle formats being covered are Over Used (OU) and Random Battles (Randbats). The former has a variety of different team compositions, found at http://pokemonshowdownteams.com/over-used-ou/. The latter format focuses more specifically on move strategies, which often give basis for a number of team strategies. The introduction to this battle format is found at http://www.smogon.com/smog/issue35/randbats-exper. 
...
* Random Battle Format (2016). Retrieved from: http://www.smogon.com/smog/issue35/randbats-expert* 
<<<<<<< HEAD
* Over Used Teams (2016). Retrieved from: http://pokemonshowdownteams.com/over-used-ou/ 
...
=======
* Over Used Teams (2016). Retrieved from: http://pokemonshowdownteams.com/over-used-ou/* 
>>>>>>> 1498b6640d98af0b9de1eca6383861c8d36e1fb7
