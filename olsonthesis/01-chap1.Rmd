...
To begin with however, Pokémon battling must explicitly be detailed for laymen and game theorists alike. 
...
There are a number of parameters and variables to consider beyond those already detailed. To begin with, each Pokémon can only learn four moves to chose from for any turn of a battle. Additionally, whenever a player has at least two Pokémon that have not fainted, they have the choice to switch into another Pokémon. Doing so counts as the player's action for the turn. Thus, players almost always have five different choices to make each turn. However, if switches are considered distinct choices, players have at most nine potential decisions for a given turn. There are also a number of other parameters to consider, though some are Pokémon and/or case-specific. Such parameters will be further detailed in the methodology section, along with further specifications on move types and Pokémon abilities. 
...
A point glossed over previously are the existence of different game end types. Though the game ends when all of the Pokémon on one team have fainted, any player has the choice to forfeit the game any time before this. Thus, the ways to end a battle are by forfeiture or by having all of their Pokémon faint before their opponents; the latter outcome is referred to as a "normal" game. Additionally, each player is able to see all past decisions. This makes Pokémon battling a perfect recall game. Furthermore as each game is composed of a sequence of turns, Pokémon battling is a sequential game. 

This point alludes to a unique trait of Pokémon battling that further details the type of game Pokémon battling is: An incomplete information game. For the Random Battle format especially, each player is given limited information about the opposing players team during the first turn. After each turn, players are able learn not only the different moves each opposing Pokémon has, but also their abilities, held items, and sometimes what other Pokémon are on the opposing team. Generally speaking, there is almost always new information revealed each turn. However, a rather interesting facet of analysis is characterizing player strategies by their previous decisions during the battle. Such analysis relies upon player strategies being revealed by their decisions in a rational and consistent manner; but incorporating such information into players own strategies poses risks that will be analyzed further. 

Taken together, Pokémon battling is a special case of a sequential imcomplete information zero sum game with perfect recall played exclusively between two players. As Pokémon battling lends itself to a discussion of imperfect information, it is all the more vital to consider the role of decision making in sequential games. A great portion of game theory literature has explored such topics. 

Specific to zero sum games, the pioneering literature of Von Neumann and Morgenstern laid the groundwork for game theory. Concerning the role of information, Zermelo in particular yields some important implications in analyzing Pokémon battling, along with the work of John Forbes Nash, Jr. Lastly the role of signalling as it relates to asymmetrical information is related to the work of Spence and Stiglitz. (INCLUDE CITATIONS OF BOTH)

A few points are worth noting. First, each game lasts a finite number of turns. Furthermore, each player has finitely many choices to make at any given turn. Thus there exists finitely many pure strategies for players to choose from each game. Thus via Nash's Existence Theorem, Pokémon battling has at least one Nash equilibrium. The question then is to determine the Nash equilibrium, possibly equilibria, for a given Pokémon battle. In doing so, the next task will be to generalize for all Pokémon battles. 

  Computationally I begin with an analysis of the distributions of turn lengths. This includes the distribution of turns without any restrictions on win type, i.e. whether the player forfeited or all their Pokémon fainted. After distributional computations I categorize moves by their strategy set, i.e. whether the set of moves for a specific Pokémon are purely damaging, non-damaging, or a mix. Using this categorization I gauge the effectiveness of purely aggressive strategy sets, noted by the use of purely damaging or mostly damaging move sets. These aggressive strategy sets are compared to purely non-damaging strategy sets and a variety of mixed strategy sets. However a large portion of analysis ultimately focuses on the relevant conditions on which to base such hypotheses. 

However, even more specifically I want to gauge whether there is a point in the battle where players follow a pure strategy set. 
  
By incorporating tenants of behavioral economics and game theory, I hope to justify the occurance of certain behavioral phenomena found in Pokémon battling. 
